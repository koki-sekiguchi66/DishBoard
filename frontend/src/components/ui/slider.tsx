/**
 * shadcn/ui Slider — 範囲入力スライダー
 *
 * @radix-ui/react-slider をベースに、Dark Pop テーマに合わせたスタイリング。
 * GoalSettings での目標カロリー・PFC比率調整に使用。
 *
 * 設計判断:
 *   - トラックは secondary 背景、選択範囲は primary 色
 *   - つまみは小さめ（モバイルでも誤タップしにくいサイズ）
 */
